...
hist(data_combine[,2],xlab = 'Width',main = 'Histogram of Width')
hist(data_combine[,3],xlab = 'Height',main = 'Histogram of Height')
hist(data_combine[,4],xlab = 'Volume',main = 'Histogram of Volume')

descp = as.report_table(report(data_combine[,c(1,2,4)]))
